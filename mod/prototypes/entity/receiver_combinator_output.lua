-- Receiver Combinator Output Entity
-- Hidden constant combinator used for ground->space signal output
-- Created automatically when a Receiver Combinator is built
...
-- Basic properties
output_combinator.name = "receiver-combinator-output"
...
-- Add get-by-unit-number flag so it can be retrieved from other surfaces
...
-- No collision (shares space with receiver)
